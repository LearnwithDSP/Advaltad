...
import { db, isSupabaseConfigured, supabase, supabaseAdmin, resetPasswordForEmail } from "../lib/supabase";
        ...
        {isResetModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <motion.div
              ...
              className="bg-white rounded-3xl border border-slate-100 shadow-2xl p-6 sm:p-8 max-w-md w-full relative overflow-hidden"
            >
              <button
                type="button"
                ...
                <form onSubmit={handlePasswordResetRequest} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 focus:border-emerald-600 focus:bg-white rounded-xl text-xs text-slate-900 focus:outline-none font-medium transition-all"
                      />
                  ...
                  <div className="flex gap-2.5 pt-2">
                    ...
                    <button
                      ...
                      className="flex-1 py-3 bg-emerald-600 hover:bg-emerald-700 disabled:bg-slate-200 disabled:text-slate-400 text-white font-bold text-xs rounded-xl shadow-md transition-all cursor-pointer flex items-center justify-center gap-2"
                    >
                      {isSendingReset ? (
                        <>
